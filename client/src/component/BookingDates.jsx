...
function BookingDates({ booking }) {
    return (
        <div className="flex flex-wrap items-center text-sm text-gray-600 gap-2 md:gap-4 mb-2">
            ...
            <p className="flex w-full lg:w-auto items-center">
            ...
            <p className="flex items-center">
                ...
                <span className="font-medium mr-1">Check-in : </span>{format(new Date(booking.checkIn), 'dd-MM-yyyy')}
            </p>
            <i className="fa-solid fa-arrow-right-long hidden md:block"></i>

            <p className="flex items-center">
                <i className="fa-regular fa-calendar-days mr-1"></i>
                <span className="font-medium mr-1">Check-out : </span>{format(new Date(booking.checkOut), 'dd-MM-yyyy')}
            </p>
